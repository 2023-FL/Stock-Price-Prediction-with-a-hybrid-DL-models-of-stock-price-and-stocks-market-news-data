...
## The Processes of building up a Hybrid Deep Learning LSTM models with Robotic Process Automation (RPA), which will scrapting data of stock price and financial news about one stock number the end-user input, and then along the variation of date, it will run merge data of historical stock price and relevant stock news; next step will execute data analysis of historical stock price as well as data analysis of NLP for analyzing special words and sentences in financial news about the stock number along the variation of date. Further step is to weight the financial words and sentences in the past certain period discretely and compare the variation of stock price in between the past disceret periods of before and after for predicting stock price in furture.
